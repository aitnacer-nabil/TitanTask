...
insert into category (ref_category, name) value ('dev', 'development');
insert into category (ref_category, name) value ('bur', 'excel');
insert into category (ref_category, name) value ('sta', 'stage');
insert into category (ref_category, name) value ('pro', 'production');
insert into category (ref_category, name) value ('rha', 'management');
